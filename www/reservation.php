...
<section class="info-section">
    <div class="info-grid">
        ...
        <div class="info-card">
            ...
            <p class="card-body">
                ⚠️ Les réservations ne sont pas encore ouvertes.<br/>
        ...
        <div class="info-card">
            ...
            <p class="card-body">
                ⚠️ Registration is not open yet.<br/>
        ...
        <div class="info-card">
            <h2 class="card-title">🇫🇷 Réservation</h2>
            <p class="card-body">
                Ca y est, les réservations sont ouvertes, vous allez être redirigés. Si vous n'êtes pas redirigez, cliquez sur le lien ci-dessous
            </p>
        ...
        <div class="info-card">
            ...
            <p class="card-body">
                ⚠️ Les réservations sont désormais clôturées. <br/>
        ...
        <div class="info-card">
            <h2 class="card-title">🇬🇧 Registration</h2>
            <p class="card-body">
                ⚠️ Registration is now closed. <br/>
